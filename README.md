...
Запити на запис виконуються послідовно з паузами та автоматичним exponential backoff для тимчасових помилок `403/429`. Лекції мають синій колір, практичні — червоний, лабораторні — жовтий.
